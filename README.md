# :airplane:[Together]
<b>파이널 프로젝트 '투게더 - 관광 종합정보포털'</b>
<hr>

### :rocket: 실제 여행객들의 경험을 기반으로 이용자 맞춤 여행 관련 정보를 한 곳에서 제공합니다!
...
사용자들에게 양질의 관광정보를 쉽게 확인하고, 직접 만드는 여행코스 기능을 통해 사용자 맞춤 여행 관련 정보를 제공하여 침체된 여행시장을 활성화한다.


## :running_woman: 투게더 | About Us
👉여행지 정보 뿐만이 아닌 근처 맛집도 함께 알고싶다면!<br>
👉홍보 기반이 아닌 경험자의 후기를 알고 싶다면!<br>
